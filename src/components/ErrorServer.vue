<template>
	<div
		class="w-10/12 bg-white border relative overflow-hidden border-Error shadow-md shadow-gray-500 flex flex-col items-center justify-center rounded-lg p-3"
	>
		...
		<div class="flex flex-col items-center text-center">
			...
			<h1 class="text-xl font-bold">Terjadi kesalahan pada server</h1>
			<div class="my-2">
				<p class="text-sm">
